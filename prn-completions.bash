...
_prn_completions()
{
    ...
    local commands="create edit complete describe history report help version purge"
    local file_commands="edit complete describe history purge"
    ...
    local purge_opts="--force"
    local all_opts="${create_opts} ${edit_opts} ${complete_opts} ${purge_opts}"
    ...
    if [[ "$cur" == -* ]]; then
        ...
        case "${words[1]}" in
            ...
            purge)    applicable_opts=$purge_opts ;;
