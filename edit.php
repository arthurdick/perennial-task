    ...
    switch ($choice) {
        case 'name':
            ...
            while (empty(trim($newName))) {
                $newName = readline("Enter the new task name: ");
        ...
        case 'due':
            $dueDate = null;
            while ($dueDate === null) {
                $dateStr = readline("Enter new due date (YYYY-MM-DD): ");
        ...
        case 'completed':
            ...
            while ($completedDate === null) {
                $dateStr = readline("Enter new last completed date (YYYY-MM-DD): ");
        ...
        case 'duration':
            ...
            break;
        case 'preview':
            $preview = readline("Preview days in advance? (Enter a number, or 0 to remove): ");
